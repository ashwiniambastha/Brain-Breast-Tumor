...
1. **Build Stage**: Builds the Docker image and pushes it to Google Artifact Registry.
2. **Deploy Stage**: Pulls the new image and updates the Kubernetes `Deployment` using GKE credentials.
